...
namespace SmartVault.DAL
{
    ...
    public class DatabaseCreation
    {
        ...
        public async Task<bool> CreateDatabase(IConfiguration configuration)
        {
            ...
            return await LogCountOnInsertedInformation(elementsToSeedCount, documentsToSeedCount);
        ...
        {
            ///This call can be extracted to a separate method to get this files. 
        ...
        private async Task<bool> LogCountOnInsertedInformation( int elementsToSeedCount, int documentsToSeedCount)
        {
            ...
            return accountCount == elementsToSeedCount && documentCount == elementsToSeedCount*documentsToSeedCount && userCount == elementsToSeedCount;
